from employability_1.app.services.deployment import deploy_model_to_main_server
from employability_1.app.services.evaluation import evaluate_active_model
from employability_1.app.services.model_registry import delete_local_family, delete_local_version
from employability_1.app.services.status import get_system_status
from employability_1.app.services.training import activate_model_version, train_or_retrain_model
from employability_1.app.views.dashboard_view import get_dashboard_html
...
def get_health_status() -> dict[str, str]:
    return {"status": "ok", "service": "employability_1"}
