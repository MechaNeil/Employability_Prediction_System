...
from employability_1.app.services.model_registry import get_active, register_version
from employability_1.app.services.training import LOCAL_MODEL_PATH, retrain_model
...
def get_model_file() -> FileResponse:
    ...
    filename = active["version_name"] + ".pkl" if active is not None else "employability1_model.pkl"
