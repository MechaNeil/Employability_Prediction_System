...
from employability_1.app.controllers import federation_controller
from employability_1.app.models.schemas import (
...
from employability_1.app.services.model_registry import get_active, get_versions
from employability_1.app.services.status import get_training_set_comparison
from employability_1.app.views.model_view import get_model_file, upload_model_file
...
def retrain(payload: TrainRequest | None = None) -> dict[str, object]:
    data = payload or TrainRequest(dataset="set2", retrain_from_main=True)
    try:
