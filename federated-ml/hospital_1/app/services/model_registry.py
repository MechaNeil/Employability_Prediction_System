...
from hospital_1.app.core.config import LEGACY_MODEL_PATH, MODEL_FAMILY, MODELS_DIR
...
def delete_local_version(version_name: str) -> dict[str, object]:
    ...
    if family is None:
        raise ValueError("No hospital model family exists.")
    ...
    return {
        "message": "Hospital-1 model version deleted.",
...
def delete_local_family() -> dict[str, object]:
    ...
    return {
        "message": "Hospital-1 model family deleted.",
        "model_family": MODEL_FAMILY,
        "deleted_files": deleted_files,
    }
