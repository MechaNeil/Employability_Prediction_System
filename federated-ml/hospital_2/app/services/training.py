...
from hospital_2.app.core.config import LEGACY_MODEL_PATH, MODELS_DIR
from hospital_2.app.services.model_registry import activate, get_active, initialize_registry, register_version
from shared.constants import FEATURE_COLUMNS, RANDOM_STATE, SET3_FILE, TARGET_COLUMN
...
def _persist_version(model, *, dataset_key: str, mode: str) -> dict[str, object]:
    tmp_path = MODELS_DIR / "_tmp_hospital_2.pkl"
...
def train_or_retrain_model(dataset_key: str = "set3", retrain_from_main: bool = False) -> dict[str, object]:
    ...
    return {
        "message": "Hospital-2 model training completed.",
...
def activate_model_version(version_name: str) -> dict[str, object]:
    ...
    return {
        "message": "Hospital-2 model version activated.",
        "active_version": entry["version_name"],
        "model_path": entry["path"],
    }
