...
from employability_2.app.core.config import LEGACY_MODEL_PATH, MODEL_FAMILY, MODELS_DIR
...
def delete_local_version(version_name: str) -> dict[str, object]:
    ...
    return {
        "message": "Employability-2 model version deleted.",
...
def delete_local_family() -> dict[str, object]:
    ...
    return {
        "message": "Employability-2 model family deleted.",
        "model_family": MODEL_FAMILY,
        "deleted_files": deleted_files,
    }
